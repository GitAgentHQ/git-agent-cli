...
var KeyRegistry = map[string]KeyDef{
	...
	"diagnose_model":          {Name: "diagnose_model", Type: "string", AllowUser: true},
	"diagnose_base_url":       {Name: "diagnose_base_url", Type: "string", AllowUser: true},
	"diagnose_api_key":        {Name: "diagnose_api_key", Type: "string", AllowUser: true},
	"diagnose_timeout":        {Name: "diagnose_timeout", Type: "duration", AllowUser: true},
...
var KeyAliases = map[string]string{
	...
	"diagnose-model":          "diagnose_model",
	"diagnose-base-url":       "diagnose_base_url",
	"diagnose-api-key":        "diagnose_api_key",
	"diagnose-timeout":        "diagnose_timeout",
